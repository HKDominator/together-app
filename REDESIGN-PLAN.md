...
Consolidated, deduped index of every Phase 1 finding across all four review passes. This table is the single source of truth for *what* needs doing; the detailed write-ups live below (and the raw per-surface design critiques in [CRITIQUES-RAW.md](CRITIQUES-RAW.md)).
