...
import { Task, Priority, TaskState } from '@/types'
...
export default function StatisticsPage() {
  ...
  const userStats = users.map(u => {
    ...
    const onTime    = mine.filter(t => t.state === 'done').length // simplified
  ...
  return (
    <div className="p-9">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { icon: '✅', label: 'Total Tasks',      value: totalCount,     sub: `+${tasks.filter(t => t.createdAt > new Date(new Date().getTime() - 30 * 60 * 1000)).length} this month`, up: true },
        ...
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
              ...
              <BarChart anaData={anaBar} danData={danBar} labels={months} />
            </div>
