...
- **Reading vocabulary** — the six Readings (frozen 2026-06-12): "Bright together", "Quiet day for both", "Carrying it together", "Different speeds today", "In step", "Each in your own weather". Names frozen 2026-06-12; the carrying/quiet boundary rule ("Carrying it together" requires both moods ∈ {tender, heavy} *and at least one heavy*; a calm low-energy day is "Quiet day for both", never hardship language) is pending product-owner review before the rule table lands.
